$(function() {
  ...
  queue().defer(d3.json, "https://guilleheufemann.github.io/rutas_navieras/json/countries2.topo.json")
         .defer(d3.json, "https://guilleheufemann.github.io/rutas_navieras/json/airports2.topo.json")
         .await(loaded);
