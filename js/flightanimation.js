$(function() {
  ...
  queue().defer(d3.json, "https://github.com/guilleheufemann/route_vessel/blob/master/countries2.topo.json")
         .defer(d3.json, "https://github.com/guilleheufemann/route_vessel/blob/master/airports2.topo.json")
         .await(loaded);
